//basado en vpl/apps/test_update_partial_model.pp
...
int main(int argc, char **argv) {
  ...
  if (argc != 2) { // Check the value of argc. If not enough parameters have been passed, inform user and exit.
	...
	std::cout << "For example: ./program /home/john/update_example \n"; // Inform the user of how to use the program
        exit(0);
  }
  ...
  // /scan_1.dat
  // /scan_origin_1.dat
  string scan_file(data_folder + "imagen-0.dat");
  string origin_file(data_folder + "imagen_origin_0.dat");
  ...
  octree.savePartialModel("octree_after_updating_img0_cortada.ot");
